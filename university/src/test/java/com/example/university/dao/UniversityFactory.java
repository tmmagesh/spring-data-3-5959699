...
class UniversityFactory {
    ...
    public static void fillUniversity(UniversityService service) {
         ...
         * Department naturalSciences = service.createDepartment("Natural Sciences",
         * deanMartin);
         * Department socialSciences = service.createDepartment("Social Sciences",
         * profKing);
         * 
         * //Humanities Courses
         * 
         * Course english101 = service.createCourse("English 101", 3, profBlack,
         * humanities);
         * Course english201 = service.createCourse("English 201", 3, profBrown,
         * humanities, english101);
         * Course english202 = service.createCourse("English 202", 4, profBlack,
         * humanities);//, english201);
         * 
         * //Natural Science Courses
         * Course chemistry = service.createCourse("Chemistry", 3, profDavis,
         * naturalSciences);
         * Course physics = service.createCourse("Physics", 3, profDavis,
         * naturalSciences, chemistry);
         * Course cProgramming = service.createCourse("C Programming", 4, profMoore,
         * naturalSciences);
         * Course jProgramming = service.createCourse("Java Programming", 4, profMoore,
         * naturalSciences);
         * 
         * //Social Science Courses
         * Course history101 = service.createCourse("History 101", 3, profMiller,
         * socialSciences);
         * Course anthro = service.createCourse("Anthropology ", 3, profKing,
         * socialSciences, history101);
         * Course sociology = service.createCourse("Sociology", 3, profKing,
         * socialSciences, history101);
         * Course psych = service.createCourse("Psychology", 3, profBlack,
         * socialSciences, english101);
         */
    }
